...
NewsletterAgent/
  ...
  newsletter_agent/
    ...
    telemetry.py             # OpenTelemetry init/shutdown/get_tracer/is_enabled/traced_generate
    cost_tracker.py          # CostTracker, LlmCallRecord, CostSummary, ModelPricing
    ...
    prompts/
      ...
      query_expansion.py     # (Deprecated) Query expansion prompt for deep research
      reasoning.py           # Planning and analysis prompts for adaptive deep research
